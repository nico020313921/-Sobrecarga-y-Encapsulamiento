    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Invernadero invernadero =
                new Invernadero(nombreSector, tipoCultivo);
            ...
            do
            {
                ...
                Console.WriteLine("Temperatura: " +
                    invernadero.TemperaturaActual + "°C");

                Console.WriteLine("Humedad: " +
                    invernadero.HumedadSuelo + "%");

                Console.WriteLine("Riego: " +
                    (invernadero.SistemaRiegoActivo ?
                    "ACTIVO" : "INACTIVO"));

                Console.WriteLine("Calefacción: " +
                    (invernadero.CalefaccionActiva ?
                    "ACTIVA" : "INACTIVA"));
